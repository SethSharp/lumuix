...
declare const forwarded: import("vue").ComputedRef<Readonly<import("@vue/shared").LooseRequired<DropdownMenuRootProps>> & {
...
declare const __VLS_self: import("vue").DefineComponent<DropdownMenuRootProps, {
