...
import { RangeCalendarCellTrigger, type RangeCalendarCellTriggerProps } from 'radix-vue';
...
declare const forwardedProps: import("vue").ComputedRef<{
    day: import("@internationalized/date").DateValue;
    month: import("@internationalized/date").DateValue;
    asChild: boolean;
...
declare const __VLS_self: import("vue").DefineComponent<__VLS_Props, {
    RangeCalendarCellTrigger: typeof RangeCalendarCellTrigger;
