...
import { RangeCalendarPrev, type RangeCalendarPrevProps } from 'radix-vue';
...
declare const forwardedProps: import("vue").ComputedRef<{
    ...
    prevPage: (placeholder: import("@internationalized/date").DateValue) => import("@internationalized/date").DateValue;
    asChild: boolean;
...
declare const __VLS_self: import("vue").DefineComponent<__VLS_Props, {
    ...
    RangeCalendarPrev: typeof RangeCalendarPrev;
    cn: typeof cn;
