...
<template>
  <SwitchRoot
    ...
    :class="
      cn(
        'focus-visible:ring-primary-950 dark:focus-visible:ring-offset-primary-950 data-[state=unchecked]:bg-primary-300 dark:focus-visible:ring-primary-300 dark:data-[state=checked]:bg-primary-800 peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary-600 dark:data-[state=unchecked]:bg-primary-600',
        props.class,
      )
    ">
    <SwitchThumb
