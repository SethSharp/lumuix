...
<template>
  <SliderRoot
    ...
    v-bind="forwarded">
    <SliderTrack
      class="bg-accent relative h-2 w-full grow overflow-hidden rounded-full data-[orientation=vertical]:w-2">
      <SliderRange class="bg-primary absolute h-full data-[orientation=vertical]:w-full" />
    </SliderTrack>
    <SliderThumb
